...
const STLAnalyzer = (() => {
  ...
  let _thicknessOverlayActive = false;
  let _thicknessGradOverlayActive = false;
  let _pressureOverlayActive = false;
  let _warpArrow = null;
  ...
  const MATERIAL_DB = {
    ABS: { name: 'ABS', category: 'GP', hasGF: false, density: 1.04, Tm: 230, Tw: 50, linearShrinkage: 0.005, volumetricShrinkage: 0.015, thermalConductivity: 0.18, specificHeat: 1400, minDraft: 1.0, TmMin: 200, TmMax: 280, TwMin: 40, TwMax: 90, shrink: 0.005, alpha: 0.08, ribRatio: 0.6 },
    PC:  { name: 'PC', category: 'EP', hasGF: false, density: 1.20, Tm: 290, Tw: 80, linearShrinkage: 0.006, volumetricShrinkage: 0.018, thermalConductivity: 0.20, specificHeat: 1250, minDraft: 1.5, TmMin: 280, TmMax: 320, TwMin: 70, TwMax: 120, shrink: 0.006, alpha: 0.12, ribRatio: 0.55 },
    'PC+ABS': { name: 'PC+ABS', category: 'EP', hasGF: false, density: 1.13, Tm: 260, Tw: 65, linearShrinkage: 0.0055, volumetricShrinkage: 0.016, thermalConductivity: 0.19, specificHeat: 1350, minDraft: 1.2, TmMin: 240, TmMax: 290, TwMin: 50, TwMax: 90, shrink: 0.0055, alpha: 0.10, ribRatio: 0.55 },
    PP:  { name: 'PP', category: 'GP', hasGF: false, density: 0.90, Tm: 220, Tw: 40, linearShrinkage: 0.015, volumetricShrinkage: 0.045, thermalConductivity: 0.15, specificHeat: 1800, minDraft: 2.0, TmMin: 200, TmMax: 260, TwMin: 20, TwMax: 80, shrink: 0.015, alpha: 0.07, ribRatio: 0.5 },
    PBT: { name: 'PBT', category: 'EP', hasGF: false, density: 1.31, Tm: 250, Tw: 60, linearShrinkage: 0.018, volumetricShrinkage: 0.054, thermalConductivity: 0.21, specificHeat: 1300, minDraft: 1.5, TmMin: 230, TmMax: 270, TwMin: 40, TwMax: 90, shrink: 0.018, alpha: 0.08, ribRatio: 0.5 },
    'PBT GF30': { name: 'PBT GF30', category: 'GF', hasGF: true, density: 1.53, Tm: 260, Tw: 80, linearShrinkage: 0.004, volumetricShrinkage: 0.012, thermalConductivity: 0.25, specificHeat: 1200, minDraft: 1.0, TmMin: 240, TmMax: 280, TwMin: 60, TwMax: 100, shrink: 0.004, alpha: 0.09, ribRatio: 0.45 },
    PA6: { name: 'PA6', category: 'EP', hasGF: false, density: 1.13, Tm: 240, Tw: 80, linearShrinkage: 0.013, volumetricShrinkage: 0.039, thermalConductivity: 0.23, specificHeat: 1700, minDraft: 1.5, TmMin: 220, TmMax: 280, TwMin: 50, TwMax: 100, shrink: 0.013, alpha: 0.07, ribRatio: 0.5 },
    PA66: { name: 'PA66', category: 'EP', hasGF: false, density: 1.14, Tm: 280, Tw: 80, linearShrinkage: 0.015, volumetricShrinkage: 0.045, thermalConductivity: 0.24, specificHeat: 1600, minDraft: 1.5, TmMin: 260, TmMax: 300, TwMin: 60, TwMax: 110, shrink: 0.015, alpha: 0.07, ribRatio: 0.5 },
    'PA66 GF30': { name: 'PA66 GF30', category: 'GF', hasGF: true, density: 1.35, Tm: 290, Tw: 90, linearShrinkage: 0.005, volumetricShrinkage: 0.015, thermalConductivity: 0.27, specificHeat: 1400, minDraft: 1.0, TmMin: 270, TmMax: 310, TwMin: 70, TwMax: 120, shrink: 0.005, alpha: 0.08, ribRatio: 0.45 },
    'PA66 GF50': { name: 'PA66 GF50', category: 'GF', hasGF: true, density: 1.56, Tm: 300, Tw: 100, linearShrinkage: 0.003, volumetricShrinkage: 0.009, thermalConductivity: 0.29, specificHeat: 1300, minDraft: 0.8, TmMin: 280, TmMax: 320, TwMin: 80, TwMax: 130, shrink: 0.003, alpha: 0.09, ribRatio: 0.4 },
    POM: { name: 'POM', category: 'EP', hasGF: false, density: 1.41, Tm: 200, Tw: 70, linearShrinkage: 0.020, volumetricShrinkage: 0.060, thermalConductivity: 0.22, specificHeat: 1500, minDraft: 0.5, TmMin: 190, TmMax: 230, TwMin: 60, TwMax: 120, shrink: 0.020, alpha: 0.09, ribRatio: 0.5 },
    PMMA: { name: 'PMMA', category: 'GP', hasGF: false, density: 1.18, Tm: 220, Tw: 60, linearShrinkage: 0.005, volumetricShrinkage: 0.015, thermalConductivity: 0.19, specificHeat: 1450, minDraft: 1.5, TmMin: 200, TmMax: 250, TwMin: 40, TwMax: 80, shrink: 0.005, alpha: 0.08, ribRatio: 0.55 },
    LCP: { name: 'LCP', category: 'HP', hasGF: false, density: 1.40, Tm: 340, Tw: 110, linearShrinkage: 0.001, volumetricShrinkage: 0.003, thermalConductivity: 0.35, specificHeat: 1200, minDraft: 0.5, TmMin: 320, TmMax: 360, TwMin: 80, TwMax: 150, shrink: 0.001, alpha: 0.11, ribRatio: 0.4 },
    TPE: { name: 'TPE', category: 'EL', hasGF: false, density: 1.15, Tm: 200, Tw: 30, linearShrinkage: 0.014, volumetricShrinkage: 0.042, thermalConductivity: 0.13, specificHeat: 1900, minDraft: 2.0, TmMin: 180, TmMax: 220, TwMin: 15, TwMax: 50, shrink: 0.014, alpha: 0.06, ribRatio: 0.6 },
    TPU: { name: 'TPU', category: 'EL', hasGF: false, density: 1.20, Tm: 210, Tw: 30, linearShrinkage: 0.012, volumetricShrinkage: 0.036, thermalConductivity: 0.14, specificHeat: 2000, minDraft: 2.0, TmMin: 190, TmMax: 230, TwMin: 15, TwMax: 50, shrink: 0.012, alpha: 0.05, ribRatio: 0.6 }
  };
  ...
  async function parseSTP(buffer) {
    // SharedArrayBuffer 체크 제거 — Electron 환경은 이미 cross-origin isolated
    // 브라우저에서 SharedArrayBuffer가 없으면 WASM fallback이 동작
    ...
    // ─── 1단계: 총 버텍스 수 미리 계산 (스택 안전한 TypedArray 방식) ───
    const MAX_TRIS = 4_000_000; // 약 4M 삼각형 안전 한도 (메모리 ~144 MB)
    let totalVerts = 0;

    for (const meshData of result.meshes) {
      if (!meshData?.attributes?.position?.array) continue;
      const posArr = meshData.attributes.position.array;
      const indexArr = meshData.index?.array ?? null;
      totalVerts += indexArr ? indexArr.length : Math.floor(posArr.length / 3);
    }
    ...
    const cappedVerts = Math.min(totalVerts, MAX_TRIS * 3);
    const flatPositions = new Float32Array(cappedVerts * 3);
    const flatNormals   = new Float32Array(cappedVerts * 3);
    let writeIdx = 0;

    // ─── 2단계: 청크 복사 (push 없이 TypedArray.set 사용 → 스택 오버플로우 없음) ───
    for (const meshData of result.meshes) {
      if (writeIdx >= cappedVerts * 3) break;
      if (!meshData?.attributes?.position?.array) continue;

      const posArr  = meshData.attributes.position.array;
      const normArr = meshData.attributes.normal?.array ?? null;
      const indexArr = meshData.index?.array ?? null;

      if (indexArr) {
        for (let i = 0; i < indexArr.length && writeIdx + 2 < flatPositions.length; i++) {
          const si = indexArr[i] * 3;
          if (si + 2 >= posArr.length) continue;
          flatPositions[writeIdx]     = posArr[si];
          flatPositions[writeIdx + 1] = posArr[si + 1];
          flatPositions[writeIdx + 2] = posArr[si + 2];
          if (normArr && si + 2 < normArr.length) {
            flatNormals[writeIdx]     = normArr[si];
            flatNormals[writeIdx + 1] = normArr[si + 1];
            flatNormals[writeIdx + 2] = normArr[si + 2];
          }
          writeIdx += 3;
        }
      } else {
        const len = Math.min(posArr.length, flatPositions.length - writeIdx);
        for (let i = 0; i + 2 < len; i += 3) {
          flatPositions[writeIdx]     = posArr[i];
          flatPositions[writeIdx + 1] = posArr[i + 1];
          flatPositions[writeIdx + 2] = posArr[i + 2];
          if (normArr && i + 2 < normArr.length) {
            flatNormals[writeIdx]     = normArr[i];
            flatNormals[writeIdx + 1] = normArr[i + 1];
            flatNormals[writeIdx + 2] = normArr[i + 2];
          }
          writeIdx += 3;
        }
      }
    ...
    // ─── 3단계: 실제로 채워진 크기로 슬라이스 ───
    const actualPositions = writeIdx < flatPositions.length ? flatPositions.slice(0, writeIdx) : flatPositions;
    const actualNormals   = writeIdx < flatNormals.length   ? flatNormals.slice(0, writeIdx)   : flatNormals;

    // ─── 4단계: 법선 재계산 (법선이 모두 0이면) ───
    const hasNormals = actualNormals.some(n => n !== 0);
    let finalNormals = actualNormals;
    if (!hasNormals) {
      const tempGeo = new THREE.BufferGeometry();
      tempGeo.setAttribute('position', new THREE.BufferAttribute(actualPositions, 3));
      tempGeo.computeVertexNormals();
      finalNormals = tempGeo.attributes.normal
        ? tempGeo.attributes.normal.array
        : new Float32Array(actualPositions.length);
    }

    // ─── 5단계: 메타데이터 추출 ───
    const textSample = new TextDecoder().decode(uint8Array.slice(0, 50000));
    let productName = 'STEP Part';
    const nameMatch = textSample.match(/FILE_NAME\s*\(\s*'([^']+)'/i) || textSample.match(/PRODUCT\s*\(\s*'([^']+)'/i);
    if (nameMatch?.[1]) productName = nameMatch[1].split(/[\\\/]/).pop();

    const faceCount  = (textSample.match(/ADVANCED_FACE/g) || []).length || result.meshes.length;
    const shellCount = (textSample.match(/CLOSED_SHELL/g)  || []).length || 1;

    const wasCapped = totalVerts > MAX_TRIS * 3;

    return {
      positions: actualPositions,
      normals:   finalNormals,
      triCount:  actualPositions.length / 9,
      isSimulated: false,
      wasCapped,
      metadata: { productName, faceCount, shellCount }
    };
  }
  ...
  function parseASCII(text) {
    ...
    while ((fm = facetRe.exec(text)) !== null) {
      ...
      if (validFacet) {
        for (let p = 0; p < tempPts.length; p++) positions.push(tempPts[p]);
  ...
  function groupPointsIntoFeatures(points, cellSize) {
    ...
    for (const key in cells) {
      ...
      while (queue.length > 0) {
        ...
        const currCell = cells[curr];
        for (let p = 0; p < currCell.length; p++) componentPoints.push(currCell[p]);
  ...
  function recolorGeometry() {
    ...
    } else if (_thicknessOverlayActive && _vertexThickness) {
      colors = computeThicknessColors(positions, _vertexThickness);
    } else if (_thicknessGradOverlayActive && _thicknessGradients) {
      colors = computeThicknessGradColors(positions, _thicknessGradients);
    } else if (_pressureOverlayActive && _pressureMap) {
      colors = computePressureColors(positions, _pressureMap);
    } else {
  ...
  async function updateCoreHelpers(visible) {
    ...
    function drawCoreMechanicalUnit(positions, color, dirStr, isSlide, index) {
      ...
      if (isSlide) {
        ...
        arrow.name = `slide_${index}_arrow`;
        ...
        label.name = `slide_${index}_label`;
        ...
        arrow.name = `lifter_${index}_arrow`;
        _coreHelpers.add(arrow);
        ...
        label.name = `lifter_${index}_label`;
        _coreHelpers.add(label);
      }
    }
    ...
    let sIdx = 1;
    finalSlides.forEach(feat => {
      drawCoreMechanicalUnit(feat.points, 0xff00cc, feat.dir, true, sIdx++); // Slide = Magenta
    });
    
    let lIdx = 1;
    finalLifters.forEach(feat => {
      drawCoreMechanicalUnit(feat.points, 0xffffff, feat.dir, false, lIdx++); // Lifter = White
    });
  ...
  function updatePartingLine(visible, heightPct, mode) {
    ...
    if (partingPoints.length > 0) {
      ...
      const coreColor = 0xffe700; // Parting Line = Yellow (spec)
  ...
  function createDefectMarkers(defects) {
    ...
    defects.forEach(def => {
      if (def.type === 'air_trap') {
        ...
        label.name = 'defect_air_trap_label';
        ...
        if (def.segments && def.segments.length > 0) {
          ...
          lineSegments.name = 'defect_weld_line';
          ...
          label.name = 'defect_weld_line_label';
        ...
        label.name = 'defect_shrinkage_label';
  ...
  function computeWallThickness() {
    ...
    const opposingThickness = new Float32Array(positions.length / 3);
    for (let i = 0; i < positions.length; i += 3) {
      const vx = positions[i], vy = positions[i + 1], vz = positions[i + 2];
      const nx = normals[i],   ny = normals[i + 1],   nz = normals[i + 2];
      ...
      opposingThickness[i / 3] = minDist === Infinity ? 0 : minDist;
    }

    // 2. Voxel SDF 기반 두께 계산
    const N = 20; // 20x20x20 voxel grid for instant calculation (~10ms)
    const h = Math.max(0.1, Math.max(size.x, size.y, size.z) / N);
    const nx = Math.ceil(size.x / h) + 2;
    const ny = Math.ceil(size.y / h) + 2;
    const nz = Math.ceil(size.z / h) + 2;
    
    // voxel type: 0 = unvisited, 1 = boundary, 2 = outside
    const voxels = new Uint8Array(nx * ny * nz);
    const getVoxIdx = (ix, iy, iz) => ix + iy * nx + iz * nx * ny;
    
    const minX = box.min.x - h;
    const minY = box.min.y - h;
    const minZ = box.min.z - h;

    // Mark boundary voxels
    const boundaryVoxels = [];
    for (let i = 0; i < positions.length; i += 3) {
      const ix = Math.floor((positions[i] - minX) / h);
      const iy = Math.floor((positions[i+1] - minY) / h);
      const iz = Math.floor((positions[i+2] - minZ) / h);
      if (ix >= 0 && ix < nx && iy >= 0 && iy < ny && iz >= 0 && iz < nz) {
        const idx = getVoxIdx(ix, iy, iz);
        if (voxels[idx] !== 1) {
          voxels[idx] = 1;
          boundaryVoxels.push([ix, iy, iz]);
        }
      }
    }

    // BFS from boundary voxels of the voxel grid (outside propagation)
    const queue = [];
    ...
    while (head < queue.length) {
      ...
      for (const [dx, dy, dz] of dirs) {
        ...
        if (nix >= 0 && nix < nx && niy >= 0 && niy < ny && niz >= 0 && niz < nz) {
          const idx = getVoxIdx(nix, niy, niz);
          if (voxels[idx] === 0) {
            voxels[idx] = 2;
            queue.push([nix, niy, niz]);
          }
        }
      }
    }

    // Inside voxels are 0. Calculate distance from inside voxels to nearest boundary voxel
    const sdfGrid = new Float32Array(nx * ny * nz).fill(0);
    for (let ix = 0; ix < nx; ix++) {
      for (let iy = 0; iy < ny; iy++) {
        for (let iz = 0; iz < nz; iz++) {
          const idx = getVoxIdx(ix, iy, iz);
          if (voxels[idx] === 0) {
            let minDistSDF = Infinity;
            boundaryVoxels.forEach(([bx, by, bz]) => {
              const dist = Math.sqrt((ix-bx)**2 + (iy-by)**2 + (iz-bz)**2) * h;
              if (dist < minDistSDF) minDistSDF = dist;
            });
            sdfGrid[idx] = minDistSDF === Infinity ? 0 : minDistSDF;
          }
        }
      }
    }

    // 3. Combine: Local, Opposing Normal, and Voxel SDF Thickness
    ...
    for (let i = 0; i < positions.length; i += 3) {
      ...
      let voxelThicknessVal = 0;
      if (ix >= 0 && ix < nx && iy >= 0 && iy < ny && iz >= 0 && iz < nz) {
        voxelThicknessVal = sdfGrid[getVoxIdx(ix, iy, iz)] * 2.0;
      }
      
      const oppThicknessVal = opposingThickness[vertIdx];
      
      let trueThick = oppThicknessVal;
      if (trueThick === 0 || trueThick === Infinity) {
        trueThick = voxelThicknessVal > 0 ? voxelThicknessVal : diag * 0.05;
      } else if (voxelThicknessVal > 0) {
        trueThick = Math.min(trueThick, voxelThicknessVal);
      }
      _vertexThickness[vertIdx] = Math.max(0.1, trueThick);
    }

    // 4. Calculate stats (avg, max, min, uniformity)
    let sum = 0, maxT = -Infinity, minT = Infinity;
    for (let i = 0; i < _vertexThickness.length; i++) {
      const val = _vertexThickness[i];
      sum += val;
      if (val > maxT) maxT = val;
      if (val < minT) minT = val;
    }
    const avg = sum / _vertexThickness.length;
    if (minT === Infinity) minT = 0;
    if (maxT === -Infinity) maxT = 0;

    // Standard deviation for Uniformity score
    let varianceSum = 0;
    for (let i = 0; i < _vertexThickness.length; i++) {
      varianceSum += (_vertexThickness[i] - avg) ** 2;
    }
    const stdDev = Math.sqrt(varianceSum / _vertexThickness.length);
    const uniformity = avg > 0 ? Math.max(0, Math.min(100, 100 - (stdDev / avg) * 80)) : 100;
    ...
    // 5. Calculate Thickness Gradient Map
    _thicknessGradients = new Float32Array(_vertexThickness.length).fill(0);
    if (_adjacencyGraph) {
      const getVertKey = (x, y, z) => `${Math.round(x*1000)/1000},${Math.round(y*1000)/1000},${Math.round(z*1000)/1000}`;
      for (let i = 0; i < positions.length; i += 3) {
        const idx = i / 3;
        const key = getVertKey(positions[i], positions[i+1], positions[i+2]);
        const node = _adjacencyGraph[key];
        if (node && node.neighbors.length > 0) {
          let gradSum = 0;
          let count = 0;
          node.neighbors.forEach(neighKey => {
            const neighNode = _adjacencyGraph[neighKey];
            if (neighNode) {
              const dist = Math.sqrt((neighNode.x - node.x)**2 + (neighNode.y - node.y)**2 + (neighNode.z - node.z)**2) || 0.1;
              const diff = Math.abs(_vertexThickness[neighNode.vertIdx] - _vertexThickness[node.vertIdx]);
              gradSum += diff / dist;
              count++;
            }
          });
          _thicknessGradients[idx] = count > 0 ? (gradSum / count) : 0;
        }
      }
    }
  }
